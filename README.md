...
| **授課教師** | 徐偉智 教授 |
| **團隊成員** | [cite_start]國立高雄科技大學 電腦與通訊工程系<br>C112110130 劉志凌 [cite: 2][cite_start]<br>C112110139 陳保均 [cite: 3][cite_start]<br>C112110140 王建宇 [cite: 4] |
| **製作日期** | [cite_start]民國 115 年 6 月 22 日 [cite: 221, 231] |

---

## 📖 專案簡介與設計核心

[cite_start]本系統為輕量化 Web 線上圖書借閱系統，專注於後端關聯式資料庫的 CRUD 邏輯實作，不刻意追求華麗視覺 [cite: 9]。主要技術特色如下：
* [cite_start]**核心功能**：具備即時庫存控管與動態借還書紀錄 [cite: 10]。
* [cite_start]**權限分流**：區分「一般使用者(學生)」與「管理者」兩種角色 [cite: 11]。
* [cite_start]**資訊安全**：導入 Session 驗證防護與參數化查詢（防範 SQL 注入） [cite: 12]。
* [cite_start]**實務應用**：確保系統在學校環境下，具備資料庫快速備份與還原的穩定性 [cite: 13]。
